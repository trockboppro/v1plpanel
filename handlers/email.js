      ...
      html: `
        <html>
          ...
          <body>
            <div class="container">
              <div class="header">
                <h2>Welcome to ${await db.get('name') || 'OverSee'}!</h2>
              </div>
              <div class="content">
                <p>Dear ${username},</p>
                ...
                <p>We hope you enjoy using ${await db.get('name') || 'OverSee'}!</p>
              </div>
              <div class="footer">
                            ...
                            <tr>
                              <td style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; padding: 35px;">
                                ...
                                <h1 style="margin-top: 0; color: #2F3133; font-size: 19px; font-weight: bold; text-align: left;">
                                  Hello from OverSee Panel!
                                </h1>
                                <!-- Intro -->
                                <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                  This is a test of the OverSee mail system. You're good to go!.
                                </p>
                                <p>
                                  Regards,
                                  <br>${await db.get('name') || 'OverSee'}
                                </p>
                              </td>
                            </tr>
                          </table>
                            ...
                            <tr>
                              <td style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; color: #AEAEAE; padding: 35px; text-align: center;">
                                <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                  &copy; ${new Date().getFullYear()} ${await db.get('name') || 'OverSee'}
                                </p>
                              </td>
                            </tr>
                          </table>
